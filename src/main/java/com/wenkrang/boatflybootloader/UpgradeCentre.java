...
public class UpgradeCentre {
    public static void upgrade() throws Exception {
            ...
            public void run() {
                try {
                    ...
                    if (true) {
                        ...
                        getServer().getPluginManager().disablePlugin(getServer().getPluginManager().getPlugin("BoatFly"));
        ...
        }.runTaskAsynchronously(BoatFly_BootLoader.getPlugin(BoatFly_BootLoader.class));
